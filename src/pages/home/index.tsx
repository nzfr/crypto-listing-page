...
const Home = () => {
  ...
  return (
    <div className='overflow-y-hidden w-full h-full p-16 bg-gray-100 flex flex-col justify-start items-start gap-4'>
      <div className='w-full h-16 flex flex-row justify-between items-start gap-2  p-4 rounded-md bg-gray-200'>
        <div
          ...
          className={`${
            selectedTab === 'IRT' ? 'bg-gray-400' : 'bg-gray-300'
        ...
        <div
          ...
          className={`${
            selectedTab === 'USDT' ? 'bg-gray-400' : 'bg-gray-300'
          } w-full h-full flex flex-row justify-center items-center cursor-pointer rounded-md p-2`}
        >
          پایه تتر
        </div>
      ...
      <div className='overflow-y-scroll w-full flex flex-col gap-2 bg-gray-200 rounded-md p-4 mb-16'>
        {dataToShow?.map((market) => {
          return (
            <div className='cursor-pointer w-full flex flex-row py-4 gap-32' key={market.id}>
